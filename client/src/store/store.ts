...
import { createChoroplethSlice, type ChoroplethSlice } from './slices/choroplethSlice';
import { createSharedActionsSlice, type SharedActionsSlice } from './slices/sharedActionsSlice';

export type AppState = OverlaySlice & LanduseSlice & PanelSlice & HillslopeSlice & ChoroplethSlice & SharedActionsSlice;
