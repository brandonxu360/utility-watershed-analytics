    ...
    <div className={classes.mainWrapper}>
      <div className={`${classes.mainContent} ${classes.contentBody}`}>
        ...
        <Typography variant="body1" mb={3}>
          ...
          and delivered to streams and water supplies after a fire. The model
          was developed to help land and water managers better understand and
          reduce the risks that post-fire ash poses to water quality,
          infrastructure, and municipal water systems.
        </Typography>
        <Typography variant="body1" mb={3}>
          WATAR is built on extensive field measurements, laboratory
          experiments, and Earth observation (satellite) data collected after
          wildfires in the western United States. It operates as an extension of
          WEPPcloud, using WEPP&rsquo;s hydrologic simulations as a foundation
          while explicitly accounting for the unique behavior of wildfire ash.
        </Typography>
        ...
        <ul>
          ...
          <li>
            Using <span>WEPP-simulated runoff and infiltration</span> to drive
            ash transport.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <span>Finite ash supply:</span> WATAR explicitly accounts for the
            fact that ash is a limited source that is gradually removed by
        ...
        <ul>
          ...
          <li>
            First-order estimates of <span>water quality impacts</span>, based
            on the fraction of fine ash most likely to dissolve and release
            chemical constituents.
          </li>
        </ul>
        <Typography variant="body1" mb={3}>
          These outputs help identify{" "}
          <strong>when and where ash poses the greatest risk</strong> following
          a wildfire.
        </Typography>
      </div>
    </div>
