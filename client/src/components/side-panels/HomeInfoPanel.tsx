...
export default function HomeSidePanelContent(): JSX.Element {
  ...
  return (
    <div className={classes.root} data-testid="home-panel">
      <Typography variant="h2" className={classes.heading}><strong>Explore Watershed Analytics</strong></Typography>
      ...
      <Typography variant="h3"><strong>Tier 1 Watersheds</strong></Typography>
      <Typography variant="body1">
        Access modeled results that provide initial insights but have not yet been calibrated.
      </Typography>
      <Typography variant="h3"><strong>Tier 2 Watersheds</strong></Typography>
      <Typography variant="body1">
