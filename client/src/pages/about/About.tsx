    ...
    <div id="about-container-main">
      ...
      <div className="row">
        ...
        <div className="col">
          <p>
            <strong>
              FireWISE (Water, Impacts, Sediment, Erosion) Watersheds
            </strong>{" "}
            ...
            <strong>short-term changes</strong> in post-fire erosion, ash
            transport, and runoff and{" "}
            <strong>longer-term watershed recovery dynamics</strong> by
            assessing vegetation regrowth and nitrogen leaching in watersheds
            across the US West.
          </p>
        </div>
      </div>
          ...
          <table>
            <tbody>
              <tr>
                <td>
                  <p className="text-center">
                    <a href="about-wepp" className="btn-link">
                      WEPP
                    </a>
                    &nbsp;
                  </p>
              ...
              <tr>
                <td>
                  <p>
                    <a href="about-rhessys" className="btn-link">
                      RHESSys
                    </a>
                    &nbsp;
                  </p>
      ...
      <div>
        ...
        <br />
        <p className="text-center">
          Building WEPP-PUFF for water utility decision support
        </p>
      </div>
