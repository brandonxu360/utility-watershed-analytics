...
describe("CoverageLineChart", () => {
    const mockLineKeys = [
        { key: "shrub", color: "#8B4513", activeFill: "#d7a17a", activeStroke: "#5c3317" },
        { key: "tree", color: "#4caf50", activeFill: "#a5d6a7", activeStroke: "#2e7d32" },
    ];
    ...
    describe("empty state", () => {
        it("shows no data message when data is empty array", () => {
            ...
            expect(screen.getByText("No data found for Test Coverage")).toBeInTheDocument();
        });
        ...
        it("shows no data message when data is undefined", () => {
            ...
            expect(screen.getByRole("status")).toBeInTheDocument();
            expect(screen.getByText("No data found for Vegetation Data")).toBeInTheDocument();
        });
    ...
    describe("rendering with data", () => {
        it("renders the chart title", () => {
            ...
            expect(screen.getByTestId("coverage-chart")).toHaveTextContent("All Coverage (2020)");
        });
    ...
    describe("line rendering", () => {
        ...
        it("applies correct stroke color to each line", () => {
            ...
            expect(screen.getByTestId("line-shrub")).toHaveAttribute("data-stroke", "#8B4513");
            expect(screen.getByTestId("line-tree")).toHaveAttribute("data-stroke", "#4caf50");
        });
        ...
        it("applies stroke width of 3 to each line", () => {
            ...
            expect(screen.getByTestId("line-shrub")).toHaveAttribute("data-stroke-width", "3");
            expect(screen.getByTestId("line-tree")).toHaveAttribute("data-stroke-width", "3");
        });

        it("renders single line when only one lineKey provided", () => {
            const singleLineKey = [
                { key: "coverage", color: "#000", activeFill: "#fff", activeStroke: "#333" },
            ];
    ...
    describe("edge cases", () => {
        ...
        it("handles data with zero coverage values", () => {
            ...
            expect(screen.getByTestId("coverage-chart")).toHaveTextContent("Zero Coverage");
            expect(screen.getByTestId("line-chart")).toBeInTheDocument();
        });
        ...
        it("renders with custom line keys", () => {
            const customLineKeys = [
                { key: "custom1", color: "#ff0000", activeFill: "#ff6666", activeStroke: "#cc0000" },
                { key: "custom2", color: "#00ff00", activeFill: "#66ff66", activeStroke: "#00cc00" },
                { key: "custom3", color: "#0000ff", activeFill: "#6666ff", activeStroke: "#0000cc" },
            ];
