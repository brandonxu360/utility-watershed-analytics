...
describe("HomeSidePanelContent", () => {
  describe("rendering", () => {
    ...
    it("renders the introductory description", () => {
      ...
      expect(
        screen.getByText(
          /Visualize and analyze hydrologic and environmental data/i,
        ),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Tier 1 Watersheds section", () => {
    ...
    it("renders Tier 1 description", () => {
      ...
      expect(
        screen.getByText(
          /Access modeled results that provide initial insights/i,
        ),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Tier 2 Watersheds section", () => {
    ...
    it("renders Tier 2 description", () => {
      ...
      expect(
        screen.getByText(
          /Explore calibrated model results for enhanced accuracy/i,
        ),
      ).toBeInTheDocument();
    });
  });
