    ...
    <div className={classes.mainWrapper}>
      <div className={`${classes.mainContent} ${classes.contentBody}`}>
        ...
        <Typography variant="body1" mb={3}>
          ...
          carbon, and nitrogen over spatially variable terrain. It bridges the
          gap between traditional hydrological models (which often ignore
          dynamic vegetation growth) and ecological models (which often ignore
          the lateral movement of water and nutrients across a landscape).
        </Typography>
        <Typography variant="body1" mb={3}>
        ...
        <ul>
          ...
          <li>
            ...
            if a forest is logged, a road is built, or a sub-division is
            developed (urbanization)?
          </li>
          <li>
            <span>Disturbances:</span> Modeling the impact of wildfires, drought
            stress, or insect outbreaks on a watershed&rsquo;s long-term
            recovery.
          </li>
          <li>
            <span>Nutrient Cycling:</span> Tracking nitrogen pollution
            (nitrification/denitrification) and how it moves from hillslopes
            into streams.
          </li>
        </ul>
        ...
        <ol>
          ...
          <li>
            <span>Zone:</span> Areas with similar climate (e.g., elevation
            bands).
          </li>
          <li>
            <span>Hillslope:</span> Defines lateral flow; water drains from
            upper hillslopes to lower ones.
          </li>
          <li>
          ...
          <li>
            <span>Canopy Stratum:</span> The vertical layers of vegetation above
            a patch (e.g., trees, shrubs, grasses).
          </li>
        </ol>
        ...
        <ul>
          ...
          <li>
            <span>TOPMODEL (or DHSVM-style routing):</span> Simulates the
            movement of water, including surface runoff, subsurface flow, and
            saturation.
          </li>
        </ul>
        ...
        <Typography variant="body1" mb={3}>
          RHESSys is data-intensive because it is spatially explicit. It
          requires two main types of data, spatial and temporal:
        </Typography>
        ...
        <ul>
          ...
          <li>
            <span>Soil Map:</span> Texture, porosity, and hydraulic
            conductivity.
          </li>
          <li>
          ...
          <li>
            <span>Vegetation Parameters:</span> Physiology tables for the
            specific plants in the region (e.g., pine vs. oak vs. grass).
          </li>
          <li>
