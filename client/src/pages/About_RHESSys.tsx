  ...
  return (
    <div className="about-panel">
      ...
      <div className={classes.nutshell}>
        <h3>IN A NUTSHELL</h3>
        <p>
          <span>What it is:</span>&nbsp; RHESSys stands for{" "}
          <em>Regional Hydro-Ecological Simulation System</em>&mdash;a GIS-based
          model designed to simulate the cycling of water, carbon, and nutrients
          (primarily nitrogen) within a landscape.
        </p>
        <p>
          <span>Purpose:</span>&nbsp; Simulates flux and storage of water,
          carbon, and nitrogen over spatially variable terrain.
        </p>
        <p>
          <span>How it works:</span>&nbsp; Calculates physical and biological
          processes within a landscape on a daily time step.
        </p>
      </div>
  ...
  return (
    <div className={classes.aboutContainerMain}>
      ...
      <p>
        ...
        answer "what if" questions regarding:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          stress, or insect outbreaks on a watershed's long-term recovery.
        </li>
        <li>
      ...
      <p>
        RHESSys is essentially a "super-model" that combines adaptations of two
        older, well-established models:
      </p>
      <ul>
        <li>
      ...
      <p>
        <span>Optional but helpful:</span> Solar radiation, wind speed, relative
        humidity (if not provided, the model estimates these using MTN-CLIM
        logic).
      </p>
      ...
      <ul>
        <li>
          <span>Hydrological Outputs:</span>
          <br />
          Streamflow (discharge), evapotranspiration (ET), soil moisture,
          snowpack depth, groundwater recharge.
          <br />
          <br />
        </li>
        <li>
          <span>Ecological Outputs:</span>
          <br />
          Net Primary Production (NPP), Gross Primary Production (GPP), leaf
          area index (LAI), plant respiration, carbon and nitrogen stores in
          soil/litter.
        </li>
      </ul>
    </div>
