  ...
  return (
    <div className="about-panel">
      ...
      <div className={classes.nutshell}>
        <h3>IN A NUTSHELL</h3>
        <p>
          <span>What it is:</span>&nbsp; The Water Erosion Prediction Project
          (WEPP) is a physically-based computer model that simulates water
          erosion on hillslopes and small watersheds.
        </p>
        <p>
          <span>Purpose:</span>&nbsp; Used by conservationists for soil and
          water management, assessing conservation effectiveness, and
          understanding soil hydrology.
        </p>
        <p>
          <span>How it works:</span>&nbsp; Uses inputs for climate, soil,
          topography, and management (like vegetation) to predict erosion,
...
export function AboutWeppMainContent() {
  ...
  return (
    <div className={classes.aboutContainerMain}>
      ...
      <h2>What is WEPP?</h2>
      <p>
        WEPP was designed to provide advanced erosion prediction technology for
        organizations involved in soil and water conservation, environmental
      ...
      <ul>
        ...
        <li>
          HUC12 watersheds, though recent developments support watersheds of up
          to <span className="text-red-400">XXXX</span> ha.
        </li>
      </ul>
      <p>The WEPP model predicts:</p>
      <ul>
        <li>
      ...
      <p>
        The primary objective of WEPP is to support soil and water conservation
        and environmental assessment. It was developed for use by agencies such
        as:
      </p>
      ...
      <p>
        ...
        simulating the physical processes that control runoff, plant growth, and
        erosion.
      </p>
      ...
      <p>
        WEPP requires daily climate inputs to drive hydrology, plant growth, and
        erosion processes. These inputs can be provided in several ways,
      ...
      <ul>
        ...
        <li>
          ...
          <br />
          The WEPPcloud interface includes a Single Storm option, allowing users
          to define storm-specific parameters such as date, total precipitation,
      ...
      <ul>
        ...
        <li>
          <span>gridMET</span>
          <br />A gridded dataset (4 km resolution) providing interpolated daily
          precipitation and maximum and minimum temperature.
        </li>
        <li>
          <span>PRISM</span>
      ...
      <ul>
        <li>
          ...
          radiation) are typically generated stochastically using CLIGEN, based
          on the nearest historical weather station data
        </li>
      </ul>
      ...
      <p>
        ...
        infiltration equation, and surface runoff is routed using kinematic wave
        equations.
      </p>
      <ul>
        <li>
          ...
          this process dominates, including erosion modeling on roads, harvested
          units, and burned areas.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          <br />
          WEPP includes subsurface flow routines that compute lateral flow using
          Darcy's law, as part of the model's continuous daily water balance.
        </li>
        <li>
          ...
          where perched water tables may periodically develop. Surface runoff is
          generated when soil water content exceeds its drainable threshold, or
          when storage capacity above a restrictive layer is exceeded.
        </li>
      </ul>
      <p>
        WEPP simulates this process by comparing soil water content to porosity
        for each soil layer, evaluated from the bottom upward. When the water
        content in the surface layer exceeds its porosity, surface runoff is
        predicted due to saturation-excess conditions.
      </p>
      ...
      <ul>
        ...
        <li>
          Includes channel hydrology, channel erosion, and impoundment analysis
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Soil file (texture, organic matter, erodibility, and other properties)
        </li>
        <li>
      ...
      <h3>Outputs</h3>
      <p>WEPP produces multiple output types depending on user needs:</p>
      <ul>
        <li>
          <span>Summary outputs:</span> runoff, erosion, sediment delivery, and
          enrichment (storm, monthly, annual, or average annual)
        </li>
        <li>
        ...
        <li>
          ...
          entire watershed and individual elements, including sediment delivery
          ratios and particle size distributions
        </li>
      </ul>
    </div>
  );
