...
describe("SubcatchmentLayer", () => {
    ...
    it("switches selection between features and restores previous style", () => {
        ...
        expect(setSelectedHillslope).toHaveBeenLastCalledWith(202, feature2.properties);
    });
    ...
    it("event handlers use latest choroplethActive/style after rerender", async () => {
        const styleFn2 = vi.fn((feature: Feature | undefined): PathOptions => ({
        ...
        await act(async () => {
            r.rerender(
                <SubcatchmentLayer data={data} style={styleFn2} choroplethActive={true} choroplethKey="k1" />
            );
        });
