    ...
    <Paper elevation={3} square className={classes.sidePanel}>
      <div className={classes.sidePanelContent}>
        ...
        <Typography variant="body1" mt={3}>
          ...
          alternatives and evaluate potential risks without waiting for
          real-world outcomes.
        </Typography>
      </div>
    </Paper>
    ...
    <div className={classes.mainWrapper}>
      <div className={`${classes.mainContent} ${classes.contentBody}`}>
        ...
        <Typography variant="body1" mb={3}>
          ...
          specific combination of land condition, disturbance, management
          action, and climate setting. By comparing scenarios, users can quickly
          evaluate how different choices&mdash;or future conditions&mdash;may
        ...
        <Typography variant="body1" mb={3}>
          ...
          evaluate relative risk, compare management alternatives, and
          understand the potential upper bounds of erosion and water quality
          impacts.
        </Typography>
        <ul>
          <li>
            <span>Undisturbed (Baseline)</span> Represents typical, healthy
            forest conditions with full ground cover. This scenario provides a
            reference point for comparing all other scenarios.
          </li>
          <li>
            <span>Thinning Treatments (Hand, Cable, Skidder)</span> Simulate
            mechanical fuel treatments with varying levels of ground
          ...
          <li>
            <span>Prescribed Fire</span> Represents planned, low-intensity
            burning that reduces ground cover more than thinning but far less
            than uncontrolled wildfire. Used to compare fire-based fuel
            management with mechanical treatments.
          </li>
          <li>
        ...
        <Typography variant="body1" mb={3}>
          Each scenario represents a complete WEPP simulation. Behind the
        ...
        <ul>
          ...
          <li>
            Support planning, mitigation, and emergency response decisions.
          </li>
        </ul>
